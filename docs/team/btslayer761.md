...
- Diagrams Created include: Activity Class diagram, DeleteCommand sequence diagram, UnmarkCommand sequence diagram, Edited checkCurrent sequence diagram  AddCommands sequence diagram
